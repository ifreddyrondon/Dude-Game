...
public class LizSherman extends Entity {
	...
	/****************************************************************************************/
	public LizSherman(TileMap _tm, StagesLevels _stage, int _xMap, int _yMap,
			double _scale) {
	...
	private void loadSprite() {
		try {
			...
			face = ImageCache.getInstance().getImage(ImagePath.HUD_CHARACTER_LIZ_SHERMAN);

			BufferedImage spriteSheet = ImageCache.getInstance().getImage(ImagePath.SPRITE_CHARACTER_LIZ_SHERMAN);
